Hello, I'm 3MAZE, hope my tool will be usefull to you! 
My knowledge are limited in JS/CSS so part of the app has been vibe-coded by Claude AI.

How to install AQUATOX_Calibration_Tool:
1. Upload the .exe in the release
